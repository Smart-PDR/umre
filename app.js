    ...
    return (
        <div className="p-4 pb-24 animate-fade-in space-y-4">
            <div className="bg-gradient-to-r from-emerald-800 to-emerald-900 rounded-2xl p-6 text-white shadow-lg mb-6">
                ...
                <p className="text-emerald-100 text-sm opacity-90">Türkiye'den Kutsal Topraklara adım adım yolculuk prosedürleri.</p>
            </div>
            ...
            <div className="text-center text-xs text-slate-400 mt-6">
                * Bilgiler 2026 yılı güncel sınır prosedürlerine göre derlenmiştir.
            </div>
        </div>
    );
};
        ...
        <div className="p-6 pb-24 animate-fade-in space-y-6">
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                <div className="relative z-10 flex justify-between items-end">
                    <div><p className="text-slate-400 text-xs uppercase tracking-wider mb-1">Durum</p><h2 className="text-3xl font-serif font-bold text-gold-400">%{progress}</h2><p className="text-xs text-slate-300 mt-1">{completed} / {items.length} Tamamlandı</p></div>
                ...
                <div className="mt-6 text-left space-y-4">
                     <div className="p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-700">
                        ...
                        <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed font-serif text-justify">
                            ...
                            <br /><br />Uygulamanın hiçbir yerinde veri kaydı yoktur, güvenle kullanabilirsiniz.    
                        </p>
                     </div>
                </div>
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700 relative">
                ...
                <div className="bg-slate-50 dark:bg-slate-900 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 mb-2">
                    ...
                    <div className="flex justify-between items-center">
                        ...
                        <select value={fromCurr} onChange={(e) => setFromCurr(e.target.value)} className="bg-white dark:bg-slate-800 font-bold text-slate-700 dark:text-slate-200 p-2 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 outline-none"><option value="SAR">🇸🇦 SAR</option><option value="USD">🇺🇸 USD</option><option value="TRY">🇹🇷 TRY</option><option value="EUR">🇪🇺 EUR</option></select>
                    </div>
                </div>
